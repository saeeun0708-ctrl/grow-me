...
const ANALYSIS = {
  ...
  charm: {
    headline: "눈을 뗄 수 없는 남다른 비주얼의 소유자",
    ...
    <div class="screen result-screen">
      ...
      <div class="insta-card-outer">
        <div class="insta-card" id="insta-card">
          ...
          <div class="ic-inner">
            <div class="ic-header">${nick}님 · ${count}명이 분석한 결과</div>
            ...
            <div class="ic-footer" style="justify-content:center">
